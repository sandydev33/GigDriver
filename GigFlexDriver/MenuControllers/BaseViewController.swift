    ...
    func slideMenuItemSelectedAtIndex(_ index: Int32) {
      ...
      //  let topViewController : UIViewController = self.navigationController!.topViewController!
        if UserDefaults.standard.string(forKey: "workerType") == "Owner"{
            ...
            case 0:
                print("Home\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("dashApp")
                break
            case 1:
                print("Scanner\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("dash")
                break
            case 2:
                print("Scanner\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("Shifts")
                break
            case 3:
                print("Scanner\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("dep")
                break
            case 4:
                print("Scanner\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("Schedule Request")
                break
            case 5:
                print("Scanner\n", terminator: "")
                self.openViewControllerBasedOnIdentifier("skill")
                break
//            case 5:
//                print("Logout\n", terminator: "")
...
//                break
    ...
    func openViewControllerBasedOnIdentifier(_ strIdentifier:String){
        ...
        let topViewController : UIViewController = self.navigationController!.topViewController!
        if (topViewController.restorationIdentifier != nil) {
...
//            while let presentedViewController = topController.presentedViewController {
//                topController = presentedViewController
//                print("topController =",topController.restorationIdentifier!)
