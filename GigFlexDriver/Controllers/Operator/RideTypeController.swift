...
import SwiftyJSON
class RideTypeController: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func hittingService(page:Int , limit:Int) {
        let url = URL(string: getAllRideTypeByOrganizationCodeByPageUrl + UserDefaults.standard.string(forKey: "organizationCode")! + "?page=" + String(page) + "&count=" + String(limit))
        self.listRideWebService(url:url!)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleNameLabel.text = "Vehicle Type: "  + self.listingJson[indexPath.row]["vehicleName"].stringValue
        cell.emailLabel.text = "Base Rate: " + self.listingJson[indexPath.row]["baseRate"].stringValue
        cell.fleetSizeLabel.text = "Rate per Mile: " + self.listingJson[indexPath.row]["baseRate"].stringValue
    ...
    func listRideWebService(url:URL) {
